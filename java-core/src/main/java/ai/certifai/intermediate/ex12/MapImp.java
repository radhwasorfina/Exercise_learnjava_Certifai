...
public class MapImp
{
    ...
    private static void configKeyValue(@NonNull Map keyValue, @NonNull String action, @NonNull String country, String phoneCode) {
         ...
         **/
        String tempCase=action;

        switch(tempCase){

            case "get": //get

            if(keyValue.containsKey(country)==true){

                out.evaluate(keyValue.get(country));
                System.out.println("---------------------------------");
                System.out.println("Country code: "+keyValue.get(country));
            ...
            if(keyValue.containsKey(country)!=true) {
                ...
                out.evaluate("True");
                System.out.println("---------------------------------");
                System.out.println("Country code: "+keyValue.put(country,phoneCode));
                System.out.println("Country: "+country);
        ...
        System.out.println(in.getTotalUseCases());
